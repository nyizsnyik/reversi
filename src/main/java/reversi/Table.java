...
/**
 * 
 * @author nyizsnyik Ez az osztály tartalmatta a játékhoz szükséges táblát és a
 *         tábla módosítására és lehérdezésére használható metódusokat.
 */
public class Table {
	...
	/**
	 * Létrehoz egy <code>Table</code> objectumost és beállítja a tábla kézdő
	 * helyzetét.
	 * 
	 * @param n
	 *            megadja hányszor hanyas legyen a tábla.
	 */
	public Table(int n) {
	 ...
	 * 
	 * @param lepes
	 *            ez egy <code>Kordinata</code> objektum ez tartalmazza a lépés
	 *            kordinátáit.
	 * @param lepesx
	 *            x tengelyen milyen irányba és menyit lépjükn.
	 * @param lepesy
	 *            y tengelyen milyen irányban és menyit lépjünk.
	 * @param jatekos
	 *            az a játékos aki lép.
	 */
	public void lep(Kordinata lepes, int jatekos) {

		for (int lepesx = -1; lepesx < 2; lepesx++) {
			for (int lepesy = -1; lepesy < 2; lepesy++) {
	...
	/**
	 * A paraméterként megkapott halmaz által tartalmazott kordinátákat értékét
	 * írja át 2-re.
	 * 
	 * @param t
	 *            egy <code>Kordinata</code> objektumokat tartalmazó rendezett
	 *            halmaz.
	 */
